        ...
        >
          <div className="flex flex-col gap-7 items-center justify-center ">
            ...
            <p className="text-sm text-center dark:text-[#E9EDE8] font-semibold max-w-lg">
              ...
              health over time, and make informed decisions all from one
              intelligent platform.
            </p>
            <button
              onClick={() => setAuthOpen(true)}
              className="bg-[#0B1909] text-[#E9EDE8] px-4 py-2 font-semibold rounded-xl text-lg hover:opacity-90 cursor-pointer"
            >
              Get Started
            </button>
          </div>
