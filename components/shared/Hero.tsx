      ...
      <div className="container mx-auto pt-16 flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="max-w-xl px-6 md:pb-2 md:px-12">
          ...
          <div className="flex gap-2">
            <button className="text-base bg-[#0B1909] text-[#EEFAED] dark:bg-[#E9EDE8] dark:text-[#0B1909] font-semibold rounded-2xl p-2.5 cursor-pointer hover:opacity-90 transition">
              Get Started
            </button>
            <button className="text-base text-[#0B1909] dark:text-[#E9EDE8] font-semibold bg-transparent border border-[#0B1909] dark:border-[#E9EDE8] rounded-2xl p-2.5 cursor-pointer">
              Learn More
            </button>
          </div>
        </div>
